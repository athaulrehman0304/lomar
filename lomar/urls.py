...
urlpatterns = [
    ...
    url(r'^Predict_Poisoning_Attack_Status_Type/$', remoteuser.Predict_Poisoning_Attack_Status_Type, name="Predict_Poisoning_Attack_Status_Type"),
    ...
    url(r'^View_Poisoning_Attack_Status_Type_Ratio/$', serviceprovider.View_Poisoning_Attack_Status_Type_Ratio, name="View_Poisoning_Attack_Status_Type_Ratio"),
    url(r'^train_model/$', serviceprovider.train_model, name="train_model"),
    url(r'^View_Predicted_Poisoning_Attack_Status_Type/$', serviceprovider.View_Predicted_Poisoning_Attack_Status_Type, name="View_Predicted_Poisoning_Attack_Status_Type"),
