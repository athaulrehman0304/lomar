...
def Predict_Poisoning_Attack_Status_Type(request):
    if request.method == "POST":
        ...
        import os
        from lomar.settings import BASE_DIR
        ...
        predict_poisoning_attack.objects.create(
        title=title,
        pubDate=pubDate,
        guid=guid,
        link=link,
        ...
        return render(request, 'RUser/Predict_Poisoning_Attack_Status_Type.html',{'objs': val})
    return render(request, 'RUser/Predict_Poisoning_Attack_Status_Type.html')
