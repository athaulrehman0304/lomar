...
--
-- Host: localhost
-- Generation Time: Aug 31, 2023 at 08:22 AM
...
-- Database: `lomar`
--
CREATE DATABASE IF NOT EXISTS `lomar` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `lomar`;
...
('4wkjrzgs3dd0uyhch6q7lxnvmeg93jw4', 'eyJ1c2VyaWQiOjF9:1qatf2:HpUbRIvsGozqrwCFkkRRX4DufJE14z4F4NAn6u0ku2o', '2023-09-12 08:01:16.291971'),
...
('o5q81yu0tf59kxg8qyfmc8272rstl0yk', 'eyJ1c2VyaWQiOjJ9:1qauFl:8_q25yN0ynjaUJru12-IYFfYGmsKPvmlWPQWmfYyfRI', '2023-09-12 08:39:13.482091'),
...
(21, 'Extra Tree Classifier', '53.5490605427975'),
(22, 'SVM', '50.73068893528184'),
(23, 'Logistic Regression', '50.73068893528184'),
(24, 'Gradient Boosting Classifier', '54.38413361169102');
...
(13, 'No Poisoning Attack Found', '50.0'),
(14, 'Poisoning Attack Found', '50.0');

-- --------------------------------------------------------

--
-- Table structure for table `remote_user_predict_poisoning_attack`
--

CREATE TABLE IF NOT EXISTS `remote_user_predict_poisoning_attack` (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `title` varchar(3000) NOT NULL,
  `pubDate` varchar(3000) NOT NULL,
  `guid` varchar(3000) NOT NULL,
  `link` varchar(3000) NOT NULL,
  `desc1` varchar(3000) NOT NULL,
  `Prediction` varchar(300) NOT NULL,
  PRIMARY KEY (`id`)
) ENGINE=InnoDB  DEFAULT CHARSET=latin1 AUTO_INCREMENT=5 ;

--
-- Dumping data for table `remote_user_predict_poisoning_attack`
--

INSERT INTO `remote_user_predict_poisoning_attack` (`id`, `title`, `pubDate`, `guid`, `link`, `desc1`, `Prediction`) VALUES
(1, 'Protests across Russia see thousands detained', 'Sun, 06 Mar 2022 23:23:59 GMT', 'https://www.bbc.co.uk/news/world-europe-60640204', 'https://www.bbc.co.uk/news/world-europe-60640204?at_medium=RSS&at_campaign=KARANGA', 'People have been held in 53 cities, from St Petersburg in the west to Vladivostok in the east.\r\n', 'No Poisoning Attack Found'),
(2, 'Twitter is part of our war effort - Ukraine minister', 'Mon, 07 Mar 2022 00:02:15 GMT', 'https://www.bbc.co.uk/news/technology-60608222', 'https://www.bbc.co.uk/news/technology-60608222?at_medium=RSS&at_campaign=KARANGA', 'Ukraine''s youngest cabinet minister, 31-year-old Mykhailo Fedorov, is leading a cyber-battle against Russia.\r\n', 'No Poisoning Attack Found'),
(3, 'Roman fort survey near Melrose aims to unveil more secrets', 'Sun, 06 Mar 2022 07:45:15 GMT', 'https://www.bbc.co.uk/news/uk-scotland-south-scotland-60602352', 'https://www.bbc.co.uk/news/uk-scotland-south-scotland-60602352?at_medium=RSS&at_campaign=KARANGA', 'Ground penetrating radar will give a clearer picture of the story of Trimontium in the Borders.\r\n', 'Poisoning Attack Found'),
(4, 'Chaos, upheaval and exhaustion for Ukraine''s disabled children', 'Tue, 08 Mar 2022 01:39:31 GMT', 'https://www.bbc.co.uk/news/world-europe-60648735', 'https://www.bbc.co.uk/news/world-europe-60648735?at_medium=RSS&at_campaign=KARANGA', 'The BBC''s Fergal Keane travels on a bus with disabled children fleeing the bombed city of Kharkiv.\r\n', 'Poisoning Attack Found');
